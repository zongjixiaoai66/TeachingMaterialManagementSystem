        ...
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='banji' ">
                    <el-form-item class="input" v-if="type!='info'"  label="院系" prop="yuanxiValue">
                        <el-input v-model="banjiForm.yuanxiValue"
            ...
            <input id="banjiId" name="banjiId" type="hidden">
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="备注" prop="xueshengContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.xueshengContent" label="备注" prop="xueshengContent">
