        ...
        <el-form
            ...
            <input id="laoshiId" name="laoshiId" type="hidden">
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="课程类别" prop="kechengTypes">
                        <el-select v-model="ruleForm.kechengTypes" :disabled="ro.kechengTypes" placeholder="请选择课程类别">
                            <el-option
                    ...
                    <div v-else>
                        <el-form-item class="input" label="课程类别" prop="kechengValue">
